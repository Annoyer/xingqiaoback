            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <a class="btn btn-primary btn-sm" target="_self" href="org_add">添加机构</a>
                        </div>
                    </div>
                </div>
                        ...
                        <c:forEach items="${organizations}" var="orga">
                            <tr class="gradeX" data-id="${orga.id}" data-name="${orga.name}">
                                ...
                                <td class="center">
                                    ...
                                    <a target="_self" href="org_modify?organizationId=${orga.id}">修改</a>
                                </td>
                            </tr>
                        </c:forEach>
                                ...
                                <%--<div class="modal-body">--%>
                                    <%--<form id="modifyOrgForm" role="form" method="post" action="modifyOrg" target="iframe0">--%>
                                        ...
                                        <%--<div class="form-group">--%>
                                            ...
                                            <%--&lt;%&ndash;<textarea class="form-control" id="abstractModify" name="abstract"></textarea>&ndash;%&gt;--%>
                                            <%--<script id="abstractModify" type="text/plain"></script>--%>
                                        <%--</div>--%>
                                        <%--<div class="form-group">--%>
                                            <%--<label for="courseModify">机构课程</label>--%>
                                            <%--&lt;%&ndash;<textarea class="form-control" id="courseModify" name="course"></textarea>&ndash;%&gt;--%>
                                            <%--<script id="courseModify" type="text/plain"></script>--%>
                                        <%--</div>--%>
                                        <%--<div class="form-group">--%>
    ...
    function detailOrganization(obj){
        ...
        $.ajax({
            ...
            success:function(data) {
                $('#orgName').text(name);
                $('#orgAbstract').html(data.orgintro.abstract);
                $('#orgCourse').html(data.orgintro.course);
                $('#orgHardware').html(data.orgintro.hardware);
                $('#orgService').html(data.orgintro.service);
                $('#orgTeam').html(data.orgintro.team);
